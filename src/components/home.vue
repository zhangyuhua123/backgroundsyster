<template>
    <div class="home" style="background:#f4f4f4">
            ...
            <div class="form-horizontal layout " style="margin-top:30px;">
                ...
                <fieldset class="contractinformation" style="margin-top:30px;background:#fff;position:relative" v-for="(item,index) in arr" :key="index">
                    ...
                    <div class="progressbar">
                        ...
                        "></el-progress>
                        <div class='lessment'><span style="font-size:39px">{{item.UnusedAccount}}</span><i>堂</i><br><span>剩余</span></div>
        ...
        <div class="layui-layer layui-layer-page layer-anim" v-show='isziliao' id="layui-layer1" type="page" times="1" showtime="0" contype="string" style="z-index: 19891015; width: 390px; height: 200px; top: 375px; left: 600px;">
    ...
    methods: {
      ...
      // `this` points to the vm instance
        ...
        confirmpasswordnation(){
             ...
             this.$http.get(url,{
               ...
               this.pleasewhitepassword1=this.newpassword;
                  alert((JSON.parse(res1).success?"修改成功":"修改失败"));
        ...
        test(){
          ...
          }else if(this.oldpassword!=this.$route.params.password){
               this.pleasewhitepassword=0;
               this.pleasewhitepassword1=1;
          }else{
              this.pleasewhitepassword=0;
               this.pleasewhitepassword1=0;
          }
